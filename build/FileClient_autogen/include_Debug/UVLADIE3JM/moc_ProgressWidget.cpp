...
QT_MOC_LITERAL(4, 38, 8), // "progress"
QT_MOC_LITERAL(5, 47, 11), // "transferred"
QT_MOC_LITERAL(6, 59, 5) // "total"

    },
    "ProgressWidget\0updateProgress\0\0taskId\0"
    "progress\0transferred\0total"
};
...
void ProgressWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateProgress((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< qint64(*)>(_a[3])),(*reinterpret_cast< qint64(*)>(_a[4]))); break;
        default: ;
        }
    }
}
