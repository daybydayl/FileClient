...
QT_MOC_LITERAL(1, 7, 18), // "logMessageReceived"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "message"
QT_MOC_LITERAL(4, 35, 7) // "isError"

    },
    "Logger\0logMessageReceived\0\0message\0"
    "isError"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logMessageReceived((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Logger::logMessageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Logger::logMessageReceived(const QString & _t1, bool _t2)
{
